...
- **Tasks**: metaworld_sweep-into-v2.
- **RM capacities**: full_rm, small_rm.
- **Seeds**: 0, 1.
...
Bad runs: metaworld_sweep-into-v2__full_rm__frequent_relabel__seed0, metaworld_sweep-into-v2__full_rm__frequent_relabel__seed1, metaworld_sweep-into-v2__small_rm__frequent_relabel__seed0, metaworld_sweep-into-v2__small_rm__frequent_relabel__seed1
...
For the `full_rm` slice, mean R̂ in `frequent_relabel` is **0.22** and mean R̂ in the positive relabel-stress slice is **0.45**. Interpret this only after checking Table 2: `frequent_relabel` is a valid negative control only if its `frac turned over` is near zero.
...
Median probe rows here: ~53. If Table 1 has `n_neg=0`, or Table 2 shows the supposed
...
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_sweep-into-v2_full_rm.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_sweep-into-v2_small_rm.png)
...
|---|---|---|---|---|---|---|
| metaworld_sweep-into-v2 | full_rm | R_hat | nan | [nan, nan] | 2 | 2 |
| metaworld_sweep-into-v2 | full_rm | kappa | 23 | [23, 23] | 2 | 2 |
| metaworld_sweep-into-v2 | full_rm | proxy_inflection | nan | [nan, nan] | 2 | 2 |
| metaworld_sweep-into-v2 | full_rm | kl_to_pretrain | 15 | [13, 25] | 2 | 2 |
| metaworld_sweep-into-v2 | full_rm | entropy_drop | nan | [nan, nan] | 2 | 2 |
| metaworld_sweep-into-v2 | full_rm | ensemble_var | nan | [nan, nan] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | R_hat | 9.25 | [9, 10] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | kappa | 9.24 | [9, 10] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | proxy_inflection | 22 | [22, 22] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | kl_to_pretrain | 30 | [30, 30] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | entropy_drop | 26 | [26, 26] | 2 | 2 |
| metaworld_sweep-into-v2 | small_rm | ensemble_var | 31 | [31, 31] | 2 | 2 |

### Table 2 — Capacity × regime summary

| capacity | regime | role | n_runs | frac turned over | turnover reasons | mean κ̂ | mean R̂ |
|---|---|---|---|---|---|---|---|
| full_rm | frequent_relabel | negative-control | 2 | 1 | confirmed:2 | 1.71 | 0.222 |
| full_rm | rare_relabel | positive | 2 | 1 | confirmed:2 | 1.91 | 0.449 |
| small_rm | frequent_relabel | negative-control | 2 | 1 | confirmed:2 | 0.48 | 1.07 |
| small_rm | rare_relabel | positive | 2 | 0.5 | confirmed:1;too_few_post_peak_points:1 | 1.38 | 0.365 |
...
Across 8 runs, the headline claim is resolved only for slices with

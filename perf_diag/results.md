...
- **Tasks**: metaworld_button-press-v2, metaworld_door-open-v2, metaworld_door-unlock-v2, metaworld_drawer-open-v2, metaworld_hammer-v2, metaworld_sweep-into-v2, metaworld_window-close-v2, walker_walk.
- **Seeds**: 0, 1, 2, 3, 4, 5.
...
**Part-3 prediction confirmed even at smoke scale:** mean R̂ in the negative-control `frequent_relabel` regime is **0.54** (close to the healthy R̂≈1), while in the positive `rare_relabel` regime it drops to **0.43** — clearly closer to the vanishing R̂=0 boundary. See [figs/Fig3.png](figs/Fig3.png), left panel: the violin for `rare_relabel` sits well below `frequent_relabel`, exactly as the spec predicts ("R̂ should be near-healthy under frequent relabeling, degrade as P_relabel grows").
...
run to populate the (FAR, lead) curve. In this pilot each run produced only ~14
...
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_button-press-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_door-open-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_door-unlock-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_drawer-open-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_hammer-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_sweep-into-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_window-close-v2.png)
- **Fig 2**: ![Fig2](figs/Fig2_walker_walk.png)
...
|---|---|---|---|---|---|
| metaworld_button-press-v2 | R_hat | 48 | [48, 48] | 1 | 0 |
| metaworld_button-press-v2 | proxy_inflection | 48 | [48, 48] | 1 | 0 |
| metaworld_button-press-v2 | kl_to_pretrain | 47 | [47, 47] | 1 | 0 |
| metaworld_button-press-v2 | entropy_drop | 48 | [48, 48] | 1 | 0 |
| metaworld_button-press-v2 | ensemble_var | 44 | [44, 44] | 1 | 0 |
| metaworld_door-open-v2 | R_hat | 0 | [0, 0] | 1 | 0 |
| metaworld_door-open-v2 | proxy_inflection | 0 | [0, 0] | 1 | 0 |
| metaworld_door-open-v2 | kl_to_pretrain | nan | [nan, nan] | 1 | 0 |
| metaworld_door-open-v2 | entropy_drop | 0 | [0, 0] | 1 | 0 |
| metaworld_door-open-v2 | ensemble_var | nan | [nan, nan] | 1 | 0 |
| metaworld_door-unlock-v2 | R_hat | 5.46 | [5, 6] | 2 | 0 |
| metaworld_door-unlock-v2 | proxy_inflection | 5.46 | [5, 6] | 2 | 0 |
| metaworld_door-unlock-v2 | kl_to_pretrain | 4.46 | [4, 5] | 2 | 0 |
| metaworld_door-unlock-v2 | entropy_drop | 5 | [5, 5] | 2 | 0 |
| metaworld_door-unlock-v2 | ensemble_var | 4.54 | [4, 5] | 2 | 0 |
| metaworld_drawer-open-v2 | R_hat | 20.7 | [14.3, 24] | 7 | 0 |
| metaworld_drawer-open-v2 | proxy_inflection | 21 | [14.9, 23.8] | 7 | 0 |
| metaworld_drawer-open-v2 | kl_to_pretrain | 23.5 | [20, 26] | 7 | 0 |
| metaworld_drawer-open-v2 | entropy_drop | 18.8 | [13.8, 23] | 7 | 0 |
| metaworld_drawer-open-v2 | ensemble_var | 17.9 | [13.4, 22.3] | 7 | 0 |
| metaworld_hammer-v2 | R_hat | 74.7 | [68, 81] | 12 | 6 |
| metaworld_hammer-v2 | proxy_inflection | 21.8 | [13, 58] | 12 | 6 |
| metaworld_hammer-v2 | kl_to_pretrain | 84.4 | [81, 94] | 12 | 6 |
| metaworld_hammer-v2 | entropy_drop | 18.9 | [11, 28.7] | 12 | 6 |
| metaworld_hammer-v2 | ensemble_var | 11.9 | [10, 17] | 12 | 6 |
| metaworld_sweep-into-v2 | R_hat | 7.4 | [6, 9] | 3 | 0 |
| metaworld_sweep-into-v2 | proxy_inflection | 6.97 | [4, 8.84] | 3 | 0 |
| metaworld_sweep-into-v2 | kl_to_pretrain | 7.68 | [6, 8.84] | 3 | 0 |
| metaworld_sweep-into-v2 | entropy_drop | 6.49 | [5.48, 8] | 3 | 0 |
| metaworld_sweep-into-v2 | ensemble_var | 6.68 | [5, 8] | 3 | 0 |
...
| walker_walk | R_hat | 6.98 | [7, 7] | 11 | 6 |
| walker_walk | proxy_inflection | 9.37 | [3, 12] | 11 | 6 |
| walker_walk | kl_to_pretrain | 6.12 | [2, 11] | 11 | 6 |
| walker_walk | entropy_drop | 5.96 | [4.91, 9] | 11 | 6 |
| walker_walk | ensemble_var | 7 | [7, 7] | 11 | 6 |
...
|---|---|---|---|---|
| frequent_relabel | 12 | 1 | 1.86 | 0.535 |
| med_relabel | 13 | 0.846 | 2.25 | 0.428 |
| rare_relabel | 28 | 0.893 | 2.12 | 0.633 |
...
This pilot is the **harness**, not the headline. Across 53 smoke runs
(6 seeds × 3 regimes × 8 task),

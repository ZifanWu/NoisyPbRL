...
- **Tasks**: metaworld_button-press-v2.
- **RM capacities**: full_rm, linear_rm, small_rm.
- **Seeds**: 0, 1.
- **Regimes** (sweep over `cfg.num_interact` = the relabel period `P_relabel`):
  frequent_relabel, rare_relabel.
...
Negative-control validation on the real runs: **FAILED**
Bad runs: metaworld_button-press-v2__full_rm__frequent_relabel__seed0, metaworld_button-press-v2__full_rm__frequent_relabel__seed1, metaworld_button-press-v2__linear_rm__frequent_relabel__seed1
...
For the `full_rm` slice, mean R̂ in `frequent_relabel` is **0.47** and mean R̂ in the positive relabel-stress slice is **0.43**. Interpret this only after checking Table 2: `frequent_relabel` is a valid negative control only if its `frac turned over` is near zero.
...
Median probe rows here: ~111. If Table 1 has `n_neg=0`, or Table 2 shows the supposed
...
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_button-press-v2_full_rm.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_button-press-v2_linear_rm.png)
- **Fig 2**: ![Fig2](figs/Fig2_metaworld_button-press-v2_small_rm.png)
...
|---|---|---|---|---|---|---|
| metaworld_button-press-v2 | full_rm | R_hat | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | full_rm | kappa | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | full_rm | proxy_inflection | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | full_rm | kl_to_pretrain | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | full_rm | entropy_drop | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | full_rm | ensemble_var | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | R_hat | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | kappa | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | proxy_inflection | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | kl_to_pretrain | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | entropy_drop | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | linear_rm | ensemble_var | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | R_hat | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | kappa | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | proxy_inflection | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | kl_to_pretrain | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | entropy_drop | nan | [nan, nan] | 2 | 2 |
| metaworld_button-press-v2 | small_rm | ensemble_var | nan | [nan, nan] | 2 | 2 |

### Table 2 — Capacity × regime summary

| capacity | regime | role | n_runs | frac turned over | turnover reasons | mean κ̂ | mean R̂ |
|---|---|---|---|---|---|---|---|
| full_rm | frequent_relabel | negative-control | 2 | 1 | confirmed:2 | 1.37 | 0.467 |
| full_rm | rare_relabel | positive | 2 | 0 | no_sustained_post_peak_drop:1;too_few_post_peak_points:1 | 2.09 | 0.433 |
| linear_rm | frequent_relabel | negative-control | 2 | 0.5 | confirmed:1;too_few_post_peak_points:1 | 0.36 | 0.939 |
| linear_rm | rare_relabel | positive | 2 | 0 | too_few_post_peak_points:2 | 0.412 | 0.923 |
| small_rm | frequent_relabel | negative-control | 2 | 0 | peak_too_late:1;too_few_post_peak_points:1 | 0.387 | 1.12 |
| small_rm | rare_relabel | positive | 2 | 0 | late_drop_too_small:1;too_few_post_peak_points:1 | 0.297 | 1 |
...
Across 12 runs, the headline claim is resolved only for slices with

...
run to populate the (FAR, lead) curve. In this pilot each run produced only ~25
...
|---|---|---|---|---|
| med_relabel | 1 | 1 | 2.09 | 0.317 |
| rare_relabel | 6 | 1 | 1.82 | 1.09 |
...
This pilot is the **harness**, not the headline. Across 7 smoke runs

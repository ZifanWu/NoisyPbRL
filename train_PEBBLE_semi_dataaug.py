...
class Workspace(object):
    ...
    def learn_reward(self, first_flag=0):
        ...
        if self.labeled_feedback > 0:
            # SURF: number of iterations proportional to labeled data size
            num_iters = int(np.ceil(
                self.cfg.reward_update * self.labeled_feedback / self.reward_model.train_batch_size))

...
mapfile -t CELL_INFO < <("/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/miniconda3/envs/bpref/bin/python" - "phase2" "${SLURM_ARRAY_TASK_ID}" "/uufs/chpc.utah.edu/common/home/u1520755/NoisyPbRL" "/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/NoisyPbRL/results" "/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/NoisyPbRL/reference_dataset" "true" <<'PY'
import shlex
import sys

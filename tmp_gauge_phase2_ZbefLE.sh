...
#SBATCH --ntasks=1
#SBATCH --job-name=gauge_phase2
#SBATCH --time=24:00:00
##SBATCH --qos=dbrown-gpu-grn
#SBATCH --partition=soc-gpu-np
#SBATCH --account=soc-gpu-np
#SBATCH --exclude=notch372,notch369,notch475,notch371
#SBATCH --output=/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/logs/gauge_pbrl/gauge_phase2_%A_%a.out
...
mapfile -t CELL_INFO < <("/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/miniconda3/envs/bpref/bin/python" - "phase2" "${SLURM_ARRAY_TASK_ID}" "/uufs/chpc.utah.edu/common/home/u1520755/NoisyPbRL" "/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/NoisyPbRL/results" "/uufs/chpc.utah.edu/common/home/dbrown-group1/zifan/NoisyPbRL/reference_dataset" "false" <<'PY'
import shlex
import sys
